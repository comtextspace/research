...
* `Форматирование` — на этом этапе редакторы форматируют книгу в формате [Comtext]([format-comtext.md]). После того как ошибки устранены книга переводится в следующий статус — `Проверка`.
...
* Корректор — могут просматривать авторов, книги и страницы, а так же редактировать страницы. При редактировании страниц доступны следующие статусы: `Распознано`, `Вычитка`, `Форматирование`.
