...
* Номера страниц должны располагаться перед страницей;
* Добавлен новый способ разметки стихотворений с помощью символа `|`;
* Большое количество менее значимых изменений и уточнений;
* Новые поля в метаинформации: `date`, `lang`, `textual-note`, `abstract`. 
